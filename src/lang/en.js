export default {
  ...
  table: {
    ...
    routeLogin: {
      needLogin: 'gateway management requires authentication',
  ...
  tips: {
    ...
    defaultPassword: 'The user\'s default password is 123456a_',
    ...
    resetPasswordSuccess: 'The selected user password reset has been reset',
  ...
  common: {
    ...
    randomMessage: {
      a: 'Have a tea break(*^__^*)',
      b: 'Do you want to have a dinner with your friends (*^▽^*)',
      c: 'Tomorrow is another day,full of hope.Is not it?(๑╹◡╹)ﾉ',
      d: 'Happy every day (◕ᴗ◕✿)',
      e: 'What delicious food did you eat today~(@^_^@)~',
      f: 'Have you smiled today?😊',
      g: 'Have you solved the problem for others today＜(▰˘◡˘▰)',
      h: 'What are you going to eat? ✧(≖ ◡ ≖)✿',
      i: 'Do you want to watch movies on weekends? o(*￣▽￣*)o'
    },
